//https://viacep.com.br
//campo para cep. Ao colocar o último dígito do cep, alterando o UF e a cidade com base nele
// >> Selecionar a cidade deve ser aswync, pois elas ainda não estão carregadas.
...
export default function () {
    ...
    return <>
        <select onChange={selecionarEstado} value={estado}>
